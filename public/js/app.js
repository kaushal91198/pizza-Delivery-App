...
// See this all logic in video part-8 at 1.20.37
...
function initAdmin(socket) {
  ...
  var orders = [];
  var markup;
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.get('/adminOrders', {
    headers: {
...
function updateCart(tag) {
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.post('/updated_cart', tag).then(function (res) {
...
addToCart.forEach(function (btn) {
  btn.addEventListener('click', function (e) {
    var pizza = JSON.parse(btn.dataset.pizza); //see data-pizza in button video(Part-6,1.35.48)
...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    var dataProp = status.dataset.status; // it give the dataset value
...
__webpack_require__(/*! C:\Users\kaushal\Desktop\Node.Js\projects\pizaaDelivery app\resources\js\app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! C:\Users\kaushal\Desktop\Node.Js\projects\pizaaDelivery app\resources\scss\app.scss */"./resources/scss/app.scss");
